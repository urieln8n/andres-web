...
export const services: SeoPage[] = [
  ...
  },
  {
    ...
    title: "CRM para negocios locales con IA | Leads, pipeline y seguimiento",
    description: "CRM para negocios locales con IA para ordenar leads, estados, propuestas, valor estimado, seguimientos y oportunidades comerciales.",
    h1: "CRM para negocios locales que convierte leads sueltos en oportunidades controladas",
    ...
    related: ["/dashboard", "/proyectos/crm-leads-ia", "/servicios/automatizacion-con-inteligencia-artificial", "/servicios/chatbot-whatsapp-ia"],
  },
  {
  ...
  },
  {
    ...
    title: "Chatbot WhatsApp con IA para negocios locales | Andrés Fabián Rendón",
    description: "Chatbot WhatsApp con IA para captar, responder, cualificar y hacer seguimiento de leads en negocios locales sin perder trato humano.",
    h1: "Chatbot WhatsApp con IA para negocios que no quieren perder leads por responder tarde",
    eyebrow: "WhatsApp IA",
    pain: "Si cada pregunta de precio, horario, reserva o presupuesto depende de respuesta manual, tus mejores oportunidades pueden enfriarse antes de hablar contigo.",
    solution: "Diseño flujos WhatsApp con IA para responder dudas frecuentes, recoger datos, cualificar intención, derivar a humano y registrar oportunidades en CRM.",
    benefits: ["Respuesta más rápida", "Captura de datos", "Cualificación de leads", "Derivación humana", "Registro en CRM", "Seguimiento comercial"],
    deliverables: ["Mapa conversacional", "FAQ comercial", "Mensajes IA", "Webhook", "Registro CRM", "Pruebas de casos reales"],
    cta: "Auditoría gratis",
    pains: ["El cliente compara varios negocios a la vez.", "WhatsApp no recoge datos útiles.", "Las conversaciones se pierden sin estado.", "El equipo repite las mismas respuestas todos los días."],
    process: [
      { title: "Auditoría de mensajes", text: "Reviso qué preguntas se repiten y dónde se pierden reservas, presupuestos o ventas." },
      { title: "Flujo de IA", text: "Diseño respuestas, preguntas de cualificación y reglas para pasar a humano cuando conviene." },
      { title: "CRM y alertas", text: "Registro el lead con servicio, urgencia, estado y próxima acción para que no quede perdido." },
      { title: "Optimización", text: "Pruebo escenarios reales y ajusto el tono para mantener velocidad sin perder cercanía." },
    ],
    faqs: [
      { question: "¿Un chatbot WhatsApp con IA sustituye a una persona?", answer: "No. Debe responder lo repetido, ordenar datos y derivar a humano cuando hay una oportunidad sensible o de alto valor." },
      { question: "¿Se puede conectar con CRM?", answer: "Sí. La idea es que cada conversación importante entre con contexto, servicio solicitado y estado comercial." },
      { question: "¿Sirve para restaurantes, barberías y servicios locales?", answer: "Sí, adaptando preguntas, horarios, reservas, presupuestos y reglas de derivación a cada negocio." },
    ],
    related: ["/servicios/crm-para-negocios-locales", "/servicios/automatizacion-con-inteligencia-artificial", "/nichos/chatbot-whatsapp-para-restaurantes", "/auditoria-gratis"],
  },
  {
    slug: "sistemas-de-reservas",
    title: "Sistemas de reservas para negocios locales | Agenda, WhatsApp y CRM",
    description: "Sistemas de reservas para negocios locales con agenda online, confirmaciones, WhatsApp, QR, CRM y dashboard comercial.",
    h1: "Sistemas de reservas para negocios locales que quieren ordenar agenda y captar más clientes",
    eyebrow: "Reservas online",
    pain: "Las reservas por mensajes manuales provocan huecos, olvidos, respuestas repetidas y poca visibilidad de clientes recurrentes.",
    solution: "Construyo sistemas de reservas conectados a web, WhatsApp, QR, CRM y dashboard para que cada cita tenga datos, estado y seguimiento.",
    benefits: ["Agenda online", "Confirmaciones", "QR de reservas", "WhatsApp conectado", "Datos de clientes", "Dashboard de citas"],
    deliverables: ["Flujo de reserva", "Página de servicios", "Reglas de disponibilidad", "Mensajes de confirmación", "Panel visual", "Integración CRM"],
    cta: "Auditoría gratis",
    pains: ["Los mensajes llegan sin orden.", "El cliente no sabe disponibilidad.", "No hay confirmación automática.", "No se aprovechan datos para volver a vender."],
    process: [
      { title: "Reglas de agenda", text: "Defino servicios, duración, horarios, recursos y condiciones para evitar reservas confusas." },
      { title: "Experiencia móvil", text: "Diseño un flujo simple para elegir servicio, dejar datos y confirmar desde móvil." },
      { title: "Conexión comercial", text: "Conecto reservas con WhatsApp, QR y CRM para seguimiento y futuras campañas." },
      { title: "Medición", text: "Preparo métricas de citas, servicios solicitados, origen y próximos pasos." },
    ],
    faqs: [
      { question: "¿Se puede usar con barberías?", answer: "Sí. Puede adaptarse por barbero, servicio, duración, disponibilidad y recordatorios." },
      { question: "¿Incluye WhatsApp?", answer: "Puede incluir WhatsApp para confirmaciones, consultas especiales o seguimiento." },
      { question: "¿Necesito un sistema completo desde el primer día?", answer: "No. Se puede empezar con un flujo simple y escalar a CRM, dashboard y automatización." },
    ],
    related: ["/casos/barberiaos", "/nichos/web-para-barberias", "/servicios/crm-para-negocios-locales", "/auditoria-gratis"],
  },
];
...
export const localPages: SeoPage[] = [
  ...
  {
    slug: "webs-para-negocios-locales",
    title: "Webs para negocios locales en Barcelona | Captación, SEO y WhatsApp",
    description: "Webs para negocios locales en Barcelona con diseño premium, SEO local, WhatsApp, formularios, CRM y automatización para captar clientes.",
    h1: "Webs para negocios locales en Barcelona que convierten visitas en clientes",
    eyebrow: "Webs locales Barcelona",
    pain: "Muchos negocios de Barcelona tienen presencia digital, pero no una web preparada para captar demanda local y convertirla en oportunidades.",
    solution: "Construyo webs premium para negocios locales con oferta clara, páginas SEO, CTA, WhatsApp, formulario, enlaces internos y base para CRM.",
    benefits: ["Captación local", "SEO Barcelona", "WhatsApp directo", "Formulario cualificado", "Diseño premium", "Preparada para CRM"],
    deliverables: ["Arquitectura SEO", "Home premium", "Páginas de servicios", "CTA auditoría", "Formulario", "Deploy"],
    cta: "Auditoría gratis",
    pains: ["La web no explica por qué elegirte.", "No cubre búsquedas por servicio y zona.", "No hay seguimiento de leads.", "El móvil no convierte rápido."],
    process: [
      { title: "Mapa local", text: "Defino servicios, zonas reales y búsquedas con intención comercial en Barcelona." },
      { title: "Oferta y diseño", text: "Construyo una experiencia premium que explica valor y guía hacia contacto." },
      { title: "SEO técnico", text: "Configuro metadata, canonical, schema, sitemap y enlaces internos." },
      { title: "Captación", text: "Integro WhatsApp, formulario y base preparada para CRM o automatización." },
    ],
    faqs: [
      { question: "¿Trabajas con cualquier negocio local?", answer: "Sí, si tiene una oferta clara o disposición para definirla: barberías, restaurantes, limpieza, clínicas, pizzerías, autónomos y servicios locales." },
      { question: "¿Incluye SEO local?", answer: "Sí. La estructura se prepara para búsquedas por servicio, nicho y zona de Barcelona." },
      { question: "¿Puede conectarse a CRM?", answer: "Sí. El formulario puede alimentar un dashboard o CRM visual para seguimiento." },
    ],
    related: ["/servicios/webs-premium-para-negocios", "/servicios/seo-local-para-negocios", "/nichos/web-para-restaurantes", "/auditoria-gratis"],
  },
  {
    slug: "automatizacion-ia-negocios",
    title: "Automatización IA para negocios en Barcelona | WhatsApp, CRM y leads",
    description: "Automatización IA para negocios en Barcelona que quieren responder más rápido, ordenar leads, conectar WhatsApp y mejorar seguimiento comercial.",
    h1: "Automatización IA para negocios en Barcelona que quieren vender sin perder leads",
    eyebrow: "IA negocios Barcelona",
    pain: "En una ciudad competitiva, responder tarde o no hacer seguimiento puede hacer que el cliente elija otra opción antes de que tu equipo actúe.",
    solution: "Diseño automatizaciones con IA para captar, responder, cualificar, avisar al equipo y registrar leads en CRM sin perder trato humano.",
    benefits: ["Respuesta rápida", "Lead scoring", "WhatsApp conectado", "CRM visual", "Seguimientos", "Menos trabajo manual"],
    deliverables: ["Mapa de procesos", "Flujo IA", "Webhook", "Mensajes", "Panel de leads", "Pruebas"],
    cta: "Auditoría gratis",
    pains: ["WhatsApp depende de memoria.", "Instagram no tiene embudo.", "Los leads no tienen estado.", "Las tareas repetidas consumen horas."],
    process: [
      { title: "Auditoría operativa", text: "Identifico dónde se pierde tiempo, respuesta y seguimiento." },
      { title: "Diseño de flujo", text: "Creo reglas para captar datos, responder, clasificar y derivar." },
      { title: "Integración", text: "Conecto web, WhatsApp, CRM, webhook o herramientas existentes." },
      { title: "Control", text: "Pruebo límites, fallbacks y casos donde debe entrar una persona." },
    ],
    faqs: [
      { question: "¿La IA responde sola a todos?", answer: "No debería. La IA debe resolver lo repetido y derivar oportunidades sensibles a una persona." },
      { question: "¿Se puede empezar con una automatización simple?", answer: "Sí. Normalmente conviene empezar con formulario, aviso interno, clasificación y seguimiento." },
      { question: "¿Funciona para negocios locales?", answer: "Sí, especialmente cuando hay preguntas repetidas, reservas, presupuestos o leads por WhatsApp." },
    ],
    related: ["/servicios/automatizacion-con-inteligencia-artificial", "/servicios/chatbot-whatsapp-ia", "/servicios/crm-para-negocios-locales", "/auditoria-gratis"],
  },
];
