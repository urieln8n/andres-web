...
export const defaultTitle = "Andrés Fabián Rendón Ramírez | IA, webs premium, SEO y automatización";
export const defaultDescription =
  "Convierto negocios locales en sistemas digitales que captan clientes, automatizan procesos y venden más con IA, webs premium, SEO local y software.";
...
export function createMetadata({
  ...
  return {
    ...
    category: "Servicios digitales, IA, automatización, SEO local y software para negocios",
    keywords: [
      ...
      "automatización IA",
      "SEO local",
      "software para negocios locales",
      "BarberíaOS",
      "Barcelona",
    ],
